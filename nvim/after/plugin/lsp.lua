...
vim.keymap.set('n', '<leader>d', vim.diagnostic.open_float, opts) -- LSP diagnostic
vim.keymap.set('n', '<leader>dp', vim.diagnostic.goto_prev, opts) -- LSP diagnostic previous
vim.keymap.set('n', '<leader>dn', vim.diagnostic.goto_next, opts) -- LSP diagnostic next
vim.keymap.set('n', '<leader>ds', vim.diagnostic.setloclist, opts) -- LSP set diagnostic loclist
